...
export default function BatchEvaluation() {
  ...
  try {
    ...
    setFormData({
      ...
      studentMarks: evalRes.data.studentMarks || [],
    });
  } catch (err) {
  ...
  try {
    ...
    // 🔁 Immediately update backend with new S3 URL
                    ...
                    <td>
                      {editMode ? (
                        <input
                          ...
                          value={s.theoryMarks}
                          onChange={e =>
                            handleMarksChange(s.student._id, 'theoryMarks', e.target.value)
                          }
                        />
                      ) : (
                        s.theoryMarks
